...
```
python scripts/hunyuan_calib.py
```
This command will prepare the calibration data as `hunyuan_calib_brecq.pt`.

2. Calibrate PixArt alpha and generate 10k images using COCO prompt.
```
python scripts/hunyuan_brecq.py --plms --cond --n_samples 1 --outdir <output_dir> --ptq --weight_bit 4 --quant_mode qdiff --cond --cali_data_path calib_sets/hunyuan_calib_brecq.pt --cali_batch_size 4 --cali_n 64 --cali_iters 2500 --cali_iters_a 1 --quant_act --act_bit <6 or 8>  --act_mantissa_bits <3 or 4> --weight_group_size 128 --weight_mantissa_bits 1 --ff_weight_mantissa 0 --coco_10k 
```
...
```
python scripts/hunyuan_brecq.py --plms --cond --n_samples 1 --outdir <output_dir> --ptq --weight_bit 4 --quant_mode qdiff --cond --cali_data_path calib_sets/hunyuan_calib_brecq.pt --cali_batch_size 4 --cali_n 64 --cali_iters 2500 --cali_iters_a 1 --quant_act --act_bit <6 or 8> --act_mantissa_bits <3 or 4> --cali_ckpt <ckpt> --resume_w --weight_group_size 128 --weight_mantissa_bits 1 --ff_weight_mantissa 0 --coco_10k 
```
```
